...
export const updateServiceDescriptionHandler = async (
    req: Request,
    res: Response,
    next: NextFunction
) => {
    ...
    try {
        ...
        // Update description for all services of this vendor
        await updateServiceByVendorId(vendor.id, { description });
